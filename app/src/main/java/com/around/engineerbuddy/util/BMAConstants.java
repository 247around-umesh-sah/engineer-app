...
public interface BMAConstants {
    ...
    final static int myreqCamera=111;
    final static int myReqWriteCamera=222;
    final static int captureCamera=333;
    final static int myreqReadGallary=444;
    final static int myreqWriteGallary=555;
