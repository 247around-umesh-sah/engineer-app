...
public class BMAAlertDialog  extends Dialog implements View.OnClickListener {
    ...
    public BMAAlertDialog(Context context, boolean isConfirmation, boolean isWarning) {
        super(context);
...
//        return BMAUIUtil.getDimension(radius);
//    }
}